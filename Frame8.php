...
<body>
    ...
    <div class="row  d-flex justify-content-center">
      ...
      <div class="stepper-wrapper ">
        <div class="stepper">
          ...
          <div class="progress-line-active" style="width: 15%;"></div>
    ...
    <div class="card-container">
      <div class="card mb-3 p-3 d-flex flex-row align-items-center justify-content-between">
        <div class="d-flex align-items-center">
          <div class="circle border border-secondary rounded-circle me-3" style="width: 24px; height: 24px"></div>
          <div>
            <h5 class="mb-0">Nature</h5>
            <p class="mb-0">Share your social profile in an instant</p>
          </div>
        </div>
        <img src="./asset/img/Frame_90.png" alt="Nature Card" width="450" height="150" class="rounded" />
      </div>
      <div class="card mb-3 p-3 d-flex flex-row align-items-center justify-content-between">
        <div class="d-flex align-items-center">
          <div class="circle border border-secondary rounded-circle me-3" style="width: 24px; height: 24px"></div>
  ...
  <div class="bg-black border-secondary border-top fixed-bottom">
    <div
      ...
      <div>
        <a href="index.php?price=<?php echo urlencode($price); ?>" class="btn btn-secondary me-3 px-4">Back</a>

        <a href="Frame9.php?price=<?php echo urlencode($price); ?>&pack=<?php echo urlencode($pack); ?>" class="btn learn-more-btn px-4">Next</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      cards.forEach(card => {
        card.addEventListener('click', function() {
          ...
          circle.classList.remove('border-secondary');
          circle.classList.add('border-warning');
        });
      });
    });
  </script>
